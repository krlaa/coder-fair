                                                                ...
                                                                ? () {
                                                                    Get.defaultDialog(
                                                                        ...
                                                                        confirm: RawMaterialButton(
                                                                          ...
                                                                          onPressed:
                                                                              () {
                                                                            controller.updateLikedCategory(widget.cat[now].listOfProjects[currentIndex].identifier,
                                                                                widget.cat[now].listOfProjects[currentIndex].likedCategory);
                                                                            widget.cat[now].listOfProjects[currentIndex].liked =
                                                                                true;
                                                                            setState(() {});
                                                                            Get.back();
                                                                          },
                                                                        ...
                                                                        buttonColor: AppColor.accentPurple,
                                                                        barrierDismissible: false,
                                                                        onCancel: () {},
                                                                        onConfirm: () {},
                                                                        title: "Like this Project",
                                                                        titleStyle: TextStyle(fontFamily: 'Raleway', color: AppColor.white),
